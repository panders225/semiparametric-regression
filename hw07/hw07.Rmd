...
lower <- exp(beta_smok - 1.96*se_beta_smok)
upper <- exp(beta_smok + 1.96*se_beta_smok)

cat("Odds ratio given by : ",beta_smok, "\n")
...
# Question 11
From the analysis conducted, it appears that the probability of having a CHD is positively associated with blood pressure, cholesterol levels, age, and smoking status.  The relationship between the continuous variables (blood pressure, cholesterol, age) and the CHD probability is linear, which means that if we increase any of these by a single unit, we will increase our CHD probability by a set amount, regardless of if we have high or low values of these inputs.  For clarification, if I am age 40, and move to age 41, I will see the same probability increase in CHD, as if I were 60 and moving to age 61, in the presence of other variables.